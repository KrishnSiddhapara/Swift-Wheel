...
const PopularVehicles = () => {
    ...
    const bikes = vehicles.filter(v => v.category === 'Bike').slice(0, 3);
    const cars = vehicles.filter(v => v.category === 'Car').slice(0, 3);
    
    // Combine them
    const popularVehicles = [...bikes, ...cars];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        Explore our most booked bikes and cars. Perfect for city travel, daily commuting, and road trips.
                    </p>
                </div>
