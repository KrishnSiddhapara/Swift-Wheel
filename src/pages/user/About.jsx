    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            SwiftWheel is a premier platform dedicated to helping users rent vehicles easily for city travel, daily commuting, and tourism. 
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              "Our vision is to become India's most trusted vehicle rental platform, setting the benchmark for quality, transparency, and customer satisfaction."
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gray-50 p-6 rounded-lg text-center shadow-sm hover:shadow-md transition-shadow">
              ...
              <h4 className="text-xl font-semibold mb-2 text-gray-800">Easy Vehicle Booking</h4>
            ...
            <div className="bg-gray-50 p-6 rounded-lg text-center shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 text-sm">From daily commuters to powerful cruisers, find the vehicle that suits you.</p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg text-center shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 text-sm">Our extensive network ensures you can pick up a vehicle near you.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
          SwiftWheel proudly plans to serve major Indian cities, bringing seamless vehicle rentals directly to your neighborhood.
        </p>
